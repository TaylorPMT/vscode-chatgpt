		...
		webviewView.webview.onDidReceiveMessage(async data => {
			switch (data.type) {
				...
				case 'login':
					...
					break;
				case 'openSettingApiKey':
					vscode.commands.executeCommand('workbench.action.openSettings', '@ext:taylorpmt-chatgpt.taylorpmt-chatgpt chatgpt.gpt3.apiKey');
					this.logEvent('settings-api-key');
					break;
				case 'openSettings':
					vscode.commands.executeCommand('workbench.action.openSettings', "@ext:taylorpmt-chatgpt.taylorpmt-chatgpt chatgpt.");
					this.logEvent("settings-opened");
					break;
				case 'openSettingsPrompt':
					vscode.commands.executeCommand('workbench.action.openSettings', "@ext:taylorpmt-chatgpt.taylorpmt-chatgpt promptPrefix");
					...
					<div id="introduction" class="flex flex-col justify-between h-full justify-center px-6 w-full relative login-screen overflow-auto">
						...
						<div class="flex flex-col gap-4 h-full items-center justify-end text-center">
							...
							<p class="max-w-sm text-center text-xs text-slate-500">
								<a title="" id="settings-button" href="#">Update settings</a>&nbsp; | &nbsp;  <a title="" id="settings-api-key" href="#">Update setting key</a>   &nbsp; | &nbsp;<a title="" id="settings-prompt-button" href="#">Update prompts</a>
							</p>
						</div>
					</div>
